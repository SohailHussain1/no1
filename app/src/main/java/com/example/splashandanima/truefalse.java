...
public class truefalse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truefalse);
            ...
            question=getResources().getStringArray(R.array.trueQ);
            solution=getResources().getStringArray(R.array.trueans);
            ...
            right.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Intent in=new Intent(truefalse.this,result2.class);
