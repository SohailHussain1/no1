        ...
        setContentView(R.layout.activity_quizes);
            ...
            left.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(index==0) {
                        Toast.makeText(quizes.this,"NO MCQS:",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        index--;
            ...
            right.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Intent in=new Intent(quizes.this,result1.class);
                    ...
                    else
                    {
                        ...
                        {
                            Toast.makeText(quizes.this,"Kindly Select An Option:",Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            });
